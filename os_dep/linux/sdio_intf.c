...
static const struct sdio_device_id sdio_ids[] = {
	...
	{.vendor = 0x024c, .device = 0xC823, .class = SDIO_CLASS_WLAN, .driver_data = RTL8822C}, /* 8822CS-VQ*/
#endif

#ifdef CONFIG_RTL8733B
	{.vendor = 0x024c, .device = 0xB733, .class = SDIO_CLASS_WLAN, .driver_data = RTL8733B}, /* SDIO+UART */
	{.vendor = 0x024c, .device = 0xB73A, .class = SDIO_CLASS_WLAN, .driver_data = RTL8733B}, /* SDIO multi */
#endif
