...
/*
 * ====================================================
 *	EEPROM/Efuse PG Offset for 8733B
 * ====================================================
 */
#define	EEPROM_TX_PWR_INX_8733B			0x10
#define	EEPROM_ChannelPlan_8733B		0xB8
#define	EEPROM_XTAL_B9_8733B			0xB9
#define	EEPROM_THERMAL_METER_8733B		0xBA
#define	EEPROM_IQK_LCK_8733B			0xBB
#define	EEPROM_2G_5G_PA_TYPE_8733B		0xBC
/* PATH A & PATH B */
#define	EEPROM_2G_LNA_TYPE_GAIN_SEL_AB_8733B	0xBD
/* PATH C & PATH D */
#define	EEPROM_2G_LNA_TYPE_GAIN_SEL_CD_8733B	0xBE
/* PATH A & PATH B */
#define	EEPROM_5G_LNA_TYPE_GAIN_SEL_AB_8733B	0xBF
/* PATH C & PATH D */
#define	EEPROM_5G_LNA_TYPE_GAIN_SEL_CD_8733B	0xC0

#define	EEPROM_RF_BOARD_OPTION_8733B		0xC1
#define	EEPROM_FEATURE_OPTION_8733B		0xC2
#define	EEPROM_RF_BT_SETTING_8733B		0xC3
#define	EEPROM_VERSION_8733B			0xC4
#define	EEPROM_CustomID_8733B			0xC5
#define	EEPROM_TX_BBSWING_2G_8733B		0xC6
#define	EEPROM_TX_PWR_CALIBRATE_RATE_8733B	0xC8
#define	EEPROM_RF_ANTENNA_OPT_8733B		0xC9
#define	EEPROM_RFE_OPTION_8733B			0xCA
#define 	EEPROM_COUNTRY_CODE_8733B		0xCB

/* RTL8733BU */
#define EEPROM_MAC_ADDR_8733BU			0x108
#define EEPROM_VID_8733BU			0x100
#define EEPROM_PID_8733BU			0x102
#define EEPROM_USB_OPTIONAL_FUNCTION0_8733BU	0x104
#define EEPROM_USB_MODE_8733BU			0x03
...
#define EEPROM_Default_CrystalCap_8733B			0x3F
