...
void rtw_odm_adaptivity_parm_set(_adapter *adapter, s8 th_l2h_ini, s8 th_edcca_hl_diff)
{
	...
	phydm_adaptivity_info_init(odm, PHYDM_ADAPINFO_TH_L2H_INI, th_l2h_ini);
	phydm_adaptivity_info_init(odm, PHYDM_ADAPINFO_TH_EDCCA_HL_DIFF, th_edcca_hl_diff);
}
...
{
	/* TODO: reason & flag */
	return bcn_control_cmd(alink->adapter, !stop);
}
