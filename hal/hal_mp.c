...
)
{
	...
	if (IS_HARDWARE_TYPE_8814A(pAdapter) || IS_HARDWARE_TYPE_8814B(pAdapter)) {
		...
		|| IS_HARDWARE_TYPE_8723D(pAdapter) || IS_HARDWARE_TYPE_8733B(pAdapter)) {
		EndPath = RF_PATH_A;
		tx_nss = 1;
...
void mpt_SetRFPath_8814A(PADAPTER	pAdapter)
{
	...
	|| defined(CONFIG_RTL8822C) || defined(CONFIG_RTL8814B) || defined(CONFIG_RTL8733B) \
...

{
	...
	if (IS_8822C_SERIES(GET_HAL_DATA(pAdapter)->version_id)
		|| IS_8733B_SERIES(GET_HAL_DATA(pAdapter)->version_id)
...
void hal_mpt_SetSingleCarrierTx(PADAPTER pAdapter, u8 bStart)
{
	...
	|| defined(CONFIG_RTL8822B) || defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8733B)
	...
	|| defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8733B)
		if (IS_HARDWARE_TYPE_JAGUAR_ALL(pAdapter)|| IS_HARDWARE_TYPE_JAGUAR3_11N(pAdapter))
